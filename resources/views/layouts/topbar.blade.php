            ...
            {{-- <div class="dropdown d-inline-block language-switch">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="{{ url('index/de') }}" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('assets/images/flags/germany.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Deutsch</span>
                    </a>

                    <!-- item-->
                    <a href="{{ url('index/it') }}" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('assets/images/flags/italy.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italiano</span>
                    </a>

                    <!-- item-->
                    <a href="{{ url('index/ru') }}" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('assets/images/flags/russia.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Русский</span>
                    </a>
                </div>
            </div> --}}
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    @if ($user->foto_perfil)
                        <img class="rounded-circle header-profile-user"
                            src="{{ url('/storage/uploads', $user->foto_perfil) }}" alt="{{ $user->name }}">
                    @endif
                    <spans
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <a class="dropdown-item" href="#">
                        ...
                        <span class="align-middle">@lang('translation.My_Wallet')</span>
                    </a> --}}
                    {{-- <a class="dropdown-item d-block" href="#">
                        ...
                        <span class="badge bg-success-subtle text-success rounded-pill mt-1 ms-2">03</span>
                    </a> --}}
                    {{-- <a class="dropdown-item" href="#">
