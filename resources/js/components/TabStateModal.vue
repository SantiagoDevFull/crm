...
export default {
    ...
    mounted() {
        ...
        EventBus.$on('edit_modal', function (tab_state) {

            this.model.id = tab_state.id;
            this.model.campain_id = tab_state.campain_id;
            this.model.name = tab_state.name;
            this.model.order = tab_state.order;
